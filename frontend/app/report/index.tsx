  ...
  return (
    <View style={styles.fullScreenContainer}>
      ...
      <SafeAreaView style={styles.topOverlay} pointerEvents="box-none">
        ...
        <TouchableOpacity style={styles.iconBtn} onPress={toggleFacing} disabled={isRecording}>
          <Ionicons name="camera-reverse" size={28} color={isRecording ? '#ffffff60' : '#fff'} />
        </TouchableOpacity>
      </SafeAreaView>
      ...
      {/* Zoom slider — shown when not recording, anchored to bottom area */}
      {!isRecording && (
      ...
      {/* Bottom controls: record button + upload */}
